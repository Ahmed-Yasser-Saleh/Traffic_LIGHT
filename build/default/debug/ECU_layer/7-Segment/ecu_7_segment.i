...
# 1 "ECU_layer/7-Segment/ecu_7_segment_confg.h" 1
# 12 "ECU_layer/7-Segment/ecu_7_segment.h" 2

# 1 "ECU_layer/7-Segment/../../MCAL_layer/GPIO/gpio.h" 1
# 12 "ECU_layer/7-Segment/../../MCAL_layer/GPIO/gpio.h"
...
# 28 "ECU_layer/7-Segment/../../MCAL_layer/GPIO/../mcal_std_types.h"
...
# 12 "ECU_layer/7-Segment/../../MCAL_layer/GPIO/gpio.h" 2


# 1 "ECU_layer/7-Segment/../../MCAL_layer/GPIO/../device_config.h" 1
# 17 "ECU_layer/7-Segment/../../MCAL_layer/GPIO/../device_config.h"
...
# 14 "ECU_layer/7-Segment/../../MCAL_layer/GPIO/gpio.h" 2

# 1 "ECU_layer/7-Segment/../../MCAL_layer/GPIO/gpio_config.h" 1
# 15 "ECU_layer/7-Segment/../../MCAL_layer/GPIO/gpio.h" 2
# 32 "ECU_layer/7-Segment/../../MCAL_layer/GPIO/gpio.h"
typedef enum {
    LOW,
    HIGH
}Logic_t;
...
# 22 "ECU_layer/7-Segment/ecu_7_segment.h"
typedef enum{
    COMMON_CATHODE,
    COMMON_ANODE
}sev_segment_st_t;
...
# 9 "ECU_layer/7-Segment/ecu_7_segment.c" 2
...
Std_ReturnType segment_pin_initialize(const segment_confg_t *segment){
    ...
    if(((void*)0) == segment)
        ...
        gpio_pin_intialize(&(segment->segment_pin[0]));
        gpio_pin_intialize(&(segment->segment_pin[1]));
        gpio_pin_intialize(&(segment->segment_pin[2]));
        gpio_pin_intialize(&(segment->segment_pin[3]));
    }
    return ret;
...
Std_ReturnType segment_write_number(const segment_confg_t *segment, uint8 num){
    ...
    if(((void*)0) == segment)
        ...
        gpio_pin_write_logic(&(segment->segment_pin[0]), num & 1);
        gpio_pin_write_logic(&(segment->segment_pin[1]), (num >> 1) & 1);
        gpio_pin_write_logic(&(segment->segment_pin[2]), (num >> 2) & 1);
        gpio_pin_write_logic(&(segment->segment_pin[3]), (num >> 3) & 1);
    }
     return ret;
